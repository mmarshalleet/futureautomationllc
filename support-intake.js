...
export async function onRequestPost({ request, env }) {
  try {
    ...
    // Allow "submit request" without forcing payment first.
    // request-support.html uses this to collect details + send notifications,
    // then optionally sends the customer to /support-checkout.html.
    const skipPayment =
    ...
    // If caller asked to skip payment, stop here.
    if (skipPayment) {
